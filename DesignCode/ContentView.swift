...
//  DesignCode
//
//  Created by Wisnu Sanjaya on 12/01/20.
    ...
    var body: some View {
        VStack(spacing:20){
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof that Wisnu has achieved the UI Design course with approval from a Design+Code instructor." )
