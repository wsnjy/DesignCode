...
let updateData = [
    Update(image: "Card1", title: "SwiftUI Advanced", text: "Take your SwiftUI app to the App Store with advanced techniques like API data, packages, CMS.", date: "Jan 1"),
    Update(image: "Card2", title: "Webflow", text: "Design and animate a high converting landing page with advanced interactions, payments, and CMS", date: "OCT 17"),
    Update(image: "Card3", title: "Protopie", text: "Quickly prototype advanced animations and interactions for mobile and web", date: "AUG 27"),
    Update(image: "Card4", title: "SwiftUI", text: "Learn how to code custom UI's, animations, gestures and componens in XCode 11", date: "JUNE 26"),
